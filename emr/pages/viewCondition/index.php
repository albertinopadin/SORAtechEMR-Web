...
<link rel="stylesheet" type="text/css" href="http://www.soratech.cardona150.com/emr/pages/viewCondition/resources/css/style.css">
<script type="text/javascript">var patientId = <?echo $_GET["patientId"]?>;</script>
<script type="text/javascript">var conditionId = <?echo $_GET["conditionId"]?>;</script>
<script type="text/javascript" src="http://www.soratech.cardona150.com/emr/pages/viewCondition/resources/javascript/script.js"></script>
<div class="page secondary">
	<div class="page-header">
		<div class="page-header-content">
			<h1>Dat<small>Condition</small></h1>
		...
		<div id="pageContent" class="page-region-content">
			<div class="tile bg-color-green icon cl">
				<div class="tile-content" onClick="deleteFunc()">
					<img src="http://www.soratech.cardona150.com/emr/pages/viewCondition/resources/images/delete.png">
				</div>
				<div class="brand">
			...
			<div class="tile bg-color-pink icon">
				<div class="tile-content" onClick="enableUpdate()">
					<img src="http://www.soratech.cardona150.com/emr/pages/viewCondition/resources/images/edit.png">
				</div>
				<div class="brand">
			...
			<div class="section">
				...
				<div class="input-control text">
					<input id="condition" type="text" class="with-helper">
